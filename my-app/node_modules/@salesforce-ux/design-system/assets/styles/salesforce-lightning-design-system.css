/*! Lightning Design System 2.16.2 */
@charset "UTF-8";
...
.slds-button--neutral:focus{
  background-color:var(--sds-c-button-neutral-color-background-hover, #fafaf9);
  border-color:var(--sds-c-button-neutral-color-border-hover, #dddbda);
}
.slds-button_neutral:active,
.slds-button--neutral:active{
  background-color:var(--sds-c-button-neutral-color-background-active, #f3f2f2);
...
.slds-button--brand:active{
  background-color:var(--sds-c-button-brand-color-background-active, #014486);
...
.slds-button_outline-brand{
  ...
  border-color:var(--sds-c-button-outline-brand-color-border, #0176d3);
}
.slds-button_outline-brand:hover, .slds-button_outline-brand:focus{
  background-color:var(--sds-c-button-outline-brand-color-background-hover, #fafaf9);
  border-color:var(--sds-c-button-outline-brand-color-border-hover, #0176d3);
}
.slds-button_outline-brand:active{
  background-color:var(--sds-c-button-outline-brand-color-background-active, #f3f2f2);
  border-color:var(--sds-c-button-outline-brand-color-border-active, #0176d3);
}
...
.slds-button--inverse:focus{
  background-color:var(--sds-c-button-inverse-color-background-hover, #fafaf9);
  border-color:var(--sds-c-button-inverse-color-border-hover, #dddbda);
}
.slds-button_inverse:active,
.slds-button--inverse:active{
  background-color:var(--sds-c-button-inverse-color-background-active, #fafaf9);
...
.slds-button--icon-border-inverse:active{
  color:var(--sds-c-button-inverse-text-color-active, #0176d3);
}
...
.slds-button--destructive{
  ...
  -webkit-transition:border 0.15s linear;
  transition:border 0.15s linear;
  background-color:var(--sds-c-button-destructive-color-background, #ba0517);
  border-color:var(--sds-c-button-destructive-color-border, #ba0517);
...
.slds-button--destructive:focus{
  background-color:var(--sds-c-button-destructive-color-background-hover, #ba0517);
  border-color:var(--sds-c-button-destructive-color-border-hover, #ba0517);
  color:var(--sds-c-button-destructive-text-color-hover, white);
}
.slds-button_destructive:active,
.slds-button--destructive:active{
  background-color:var(--sds-c-button-destructive-color-background-active, #8e030f);
  border-color:var(--sds-c-button-destructive-color-border-active, #8e030f);
...
.slds-button_text-destructive{
  ...
  color:var(--sds-c-button-text-destructive-text-color, #ea001e);
}
.slds-button_text-destructive:hover, .slds-button_text-destructive:focus{
  background-color:var(--sds-c-button-text-destructive-color-background-hover, #fafaf9);
  border-color:var(--sds-c-button-text-destructive-color-border-hover, #dddbda);
  color:var(--sds-c-button-text-destructive-text-color-hover, #ba0517);
}
.slds-button_text-destructive:active{
  background-color:var(--sds-c-button-text-destructive-color-background-active, #f3f2f2);
  border-color:var(--sds-c-button-text-destructive-color-border-active, #dddbda);
  color:var(--sds-c-button-text-destructive-text-color-active, #ba0517);
}
...
.slds-button--success{
  ...
  border-color:var(--sds-c-button-success-color-border, #91db8b);
...
.slds-button--success:focus{
  background-color:var(--sds-c-button-success-color-background-hover, #2e844a);
  border-color:var(--sds-c-button-success-color-border-hover, #2e844a);
  color:var(--sds-c-button-success-text-color-hover, white);
}
.slds-button_success:active,
.slds-button--success:active{
  background-color:var(--sds-c-button-success-color-background-active, #2e844a);
  border-color:var(--sds-c-button-success-color-border-active, #2e844a);
...
.slds-button--neutral.slds-is-selected:focus:not([disabled]){
  background-color:var(--sds-c-button-neutral-color-background, #fafaf9);
  border-color:var(--sds-c-button-neutral-color-border-hover, #dddbda);
}
...
.slds-icon-standard-budget{
  background-color:var(--sds-c-icon-color-background, #107cad);
}
...
.slds-icon-standard-orchestrator{
  background-color:var(--sds-c-icon-color-background, #006eb3);
}
...
.slds-icon-standard-product-consumed-state{
  background-color:var(--sds-c-icon-color-background, #06a59a);
}
...
.slds-icon-standard-product-transfer-state{
  background-color:var(--sds-c-icon-color-background, #e3734f);
}
...
.slds-icon-standard-medication{
  background-color:var(--sds-c-icon-color-background, #4ac076);
}
...
.slds-icon-standard-incident{
  background-color:var(--sds-c-icon-color-background, #ba0517);
}
...
.slds-icon-standard-selling-model{
  background-color:var(--sds-c-icon-color-background, #ad7bee);
}
...
.slds-icon-standard-calculated-insights{
  background-color:var(--sds-c-icon-color-background, #54a7f8);
}
...
.slds-icon-standard-problem{
  background-color:var(--sds-c-icon-color-background, #fe9339);
}
...
.slds-accordion__summary-action:hover, .slds-accordion__summary-action:focus{
  color:var(--sds-c-accordion-heading-text-color-hover, #014486);
}
...
.slds-textarea:focus, .slds-textarea:active{
  ...
  border-color:var(--sds-c-textarea-color-border-focus, #1b96ff);
  -webkit-box-shadow:var(--sds-c-textarea-shadow-focus, 0 0 3px #0176d3);
          box-shadow:var(--sds-c-textarea-shadow-focus, 0 0 3px #0176d3);
}
...
.slds-radio [type=radio]:checked + .slds-radio_faux:after, .slds-radio [type=radio]:checked + .slds-radio--faux:after, .slds-radio [type=radio]:checked ~ .slds-radio_faux:after, .slds-radio [type=radio]:checked ~ .slds-radio--faux:after, .slds-radio [type=radio]:checked + .slds-radio__label .slds-radio_faux:after, .slds-radio [type=radio]:checked + .slds-radio__label .slds-radio--faux:after{
  ...
  border-radius:50%;
  background:none;
  background-color:var(--sds-c-radio-mark-color-foreground, #0176d3);
}
.slds-radio [type=radio]:focus + .slds-radio_faux, .slds-radio [type=radio]:focus + .slds-radio--faux, .slds-radio [type=radio]:focus ~ .slds-radio_faux, .slds-radio [type=radio]:focus ~ .slds-radio--faux, .slds-radio [type=radio]:focus + .slds-radio__label .slds-radio_faux, .slds-radio [type=radio]:focus + .slds-radio__label .slds-radio--faux{
  border-color:var(--sds-c-radio-color-border-focus, #1b96ff);
  -webkit-box-shadow:var(--sds-c-radio-shadow-focus, 0 0 3px #0176d3);
          box-shadow:var(--sds-c-radio-shadow-focus, 0 0 3px #0176d3);
}
...
.slds-slider__range::-webkit-slider-thumb{
  ...
  background:none;
  background-color:var(--sds-c-slider-thumb-color-foreground, #0176d3);
  border:0;
...
.slds-slider__range::-webkit-slider-thumb:hover{
  background-color:var(--sds-c-slider-thumb-color-foreground-hover, #014486);
}
...
.slds-slider__range:focus::-webkit-slider-thumb{
  background-color:var(--sds-c-slider-thumb-color-foreground-focus, #014486);
  -webkit-box-shadow:var(--sds-c-slider-thumb-shadow-focus, 0 0 3px #0176d3);
          box-shadow:var(--sds-c-slider-thumb-shadow-focus, 0 0 3px #0176d3);
}
.slds-slider__range:active::-webkit-slider-thumb{
  background-color:var(--sds-c-slider-thumb-color-foreground-active, #014486);
}
...
.slds-popover--tooltip{
  ...
  background-color:var(--sds-c-tooltip-color-background, #032d60);
  border:0;
}
...
.slds-combobox_container.slds-has-selection .slds-combobox__input-value:focus{
  -webkit-box-shadow:0 0 0 2px white inset, 0 0 0 3px #dddbda inset;
          box-shadow:0 0 0 2px white inset, 0 0 0 3px #dddbda inset;
}
...
.slds-pill:hover{
  background-color:var(--sds-c-pill-color-background-hover, #fafaf9);
}
.slds-pill:focus{
  outline:0;
  border-color:var(--sds-c-pill-color-border-focus, #1b96ff);
  -webkit-box-shadow:var(--sds-c-pill-shadow-focus, 0 0 3px #0176d3);
          box-shadow:var(--sds-c-pill-shadow-focus, 0 0 3px #0176d3);
}
.slds-pill a{
  text-decoration:none;
}
...
.slds-pill__label:focus{
  outline:0;
  border-radius:0.25rem;
  -webkit-box-shadow:var(--sds-c-pill-label-shadow-focus, 0 0 3px #0176d3);
          box-shadow:var(--sds-c-pill-label-shadow-focus, 0 0 3px #0176d3);
}
...
.slds-pill__action:focus{
  outline:0;
  border-color:var(--sds-c-pill-action-color-border, #1b96ff);
  -webkit-box-shadow:var(--sds-c-pill-action-shadow, 0 0 3px #0176d3);
          box-shadow:var(--sds-c-pill-action-shadow, 0 0 3px #0176d3);
}
.slds-has-error{
  border-color:var(--sds-c-pill-error-color-border, #ea001e);
}
.slds-has-error:active{
  border-color:var(--sds-c-pill-error-color-border-active, #ea001e);
}
.slds-has-error .slds-pill__label{
  font-weight:700;
  color:var(--sds-c-pill-error-text-color, #ea001e);
}
...
.slds-progress_shade .slds-progress__item.slds-is-active .slds-progress__marker:focus, .slds-progress--shade .slds-progress__item.slds-is-active .slds-progress__marker:focus{
  -webkit-box-shadow:#f3f2f2 0 0 0 4px, 0 0 3px 4px #014486;
          box-shadow:#f3f2f2 0 0 0 4px, 0 0 3px 4px #014486;
}
...
.slds-rich-text-area__content{
  overflow-y:auto;
  min-height:var(--sds-c-textarea-sizing-min-height, 6rem);
  max-height:var(--sds-c-textarea-sizing-max-height, 15rem);
  padding:1rem;
  background-color:white;
}
...
.slds-tabs--default__item.slds-is-active:after{
  background-color:var(--sds-c-tabs-item-color-border-active, #1b96ff);
...
.slds-tabs--default__item:hover:after{
  ...
  background-color:var(--sds-c-tabs-item-color-border-hover, #0176d3);
}
